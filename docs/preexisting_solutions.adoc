...
[underline]#What timescale defines long-term use?#
...
===== [.yellow-background]#Prior Bleeding/Transfusion#
...
* Platelet dysfunction ([.yellow-background]#is this a specific thing?#)
* von Willebrand disease
* Clotting factor deficiencies (including factors VII, VIII [hemophilia A], IX
[hemophilia B], and XI)
* Acquired antibodies to clotting factors ([.yellow-background]#more detail required?#)
* [.yellow-background]#Anything else? HBR paper mentions "such as [...] among others" when giving the list above#

===== Cirrhosis with Portal Hypertension

Presence of liver cirrhosis with portal hypertension is a major criterion. [.yellow-background]#So liver cirrhosis on its own is not a criterion?#
...
* [.yellow-background]#What constitutes major surgery? Could we make a list of the most common possibilities?#
...
Major surgery or major trauma ([.yellow-background]#what is in these categories?#) within 30 days before PCI is a major ARC criterion.

===== Long-term Oral NSAID/Steroid Use

Planned daily intake of oral NSAID/steriods for >4 d/wk ([.yellow-background]#what timeframe is this? Looks like days/week, but ARC paper phrases it like a duration#) is a minor ARC criterion.
