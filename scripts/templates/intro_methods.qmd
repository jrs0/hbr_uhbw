...
#| tbl-cap: "Total number of outcomes that occurred within 1 year of the index ACS. The dataset contains {{ num_index_spells }} ACS events between the dates {{ index_start }} and {{ index_end }}"

pd.read_pickle("{{ outcome_prevalences_file }}")
```
