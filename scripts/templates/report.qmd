...
abstract: |
  ...
  **Results** For predicting bleeding events, accuracy is in the range of {{ worst_bleeding_model_auc }} ({{ worst_bleeding_model_name }}) to {{ best_bleeding_model_auc }} ({{ best_bleeding_model_name }}), with {{ best_bleeding_top_features }} being the most important explanatory variables in the best model. For predicting further ischaemic events, accuracy is in the range of {{ worst_ischaemia_model_auc }} ({{ worst_ischaemia_model_name }}) to {{ best_ischaemia_model_auc }} ({{ best_ischaemia_model_name }}), with {{ best_ischaemia_top_features }} being the most important explanatory variables in the best model.
