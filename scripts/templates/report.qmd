...
abstract: |
  ...
  **Results** For predicting bleeding events, accuracy is in the range of 0.xx (worst model) to 0.xx (best model), with xx, xx and xx being the most important explanatory variables in the best model. For predicting further ischaemic events, accuracy is in the range of 0.xx (worst model) to 0.xx (best model), with xx, xx and xx being the most important explanatory variables in the best model. 
