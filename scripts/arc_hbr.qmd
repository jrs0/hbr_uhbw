...
min_index_results = features.filter(regex="^min_index")
missingness = (
...
pretty_presc = prescriptions[["name", "group", "on_admission"]]
pretty_presc = pretty_presc.rename(
    columns={
        "name": "Medicine",
        "group": "Class",
